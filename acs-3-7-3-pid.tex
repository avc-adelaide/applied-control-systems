...
\frametitle{CC tuning method}
  ...
  \midrule
  \STRUT{12pt}{3pt}%
  P   & \frac{1}{a}\Bigl(1+\frac{0.35\tau}{1-\tau}\Bigr) && \\
  \STRUT{12pt}{3pt}%
  PI  & \frac{0.9}{a}\Bigl(1+\frac{0.92\tau}{1-\tau}\Bigr) &
        L\cdot\frac{3.3-3\tau}{1+1.2\tau} & \\
  \STRUT{12pt}{3pt}%
  PD  & \frac{1.24}{a}\Bigl(1+\frac{0.13\tau}{1-\tau}\Bigr) &&
        L\cdot\frac{0.27-0.36\tau}{1-0.87\tau} \\
  \STRUT{12pt}{3pt}%
  PID & \frac{1.35}{a}\Bigl(1+\frac{0.18\tau}{1-\tau}\Bigr) &
        L\cdot\frac{2.5-2\tau}{1-0.39\tau} &
        L\cdot\frac{0.37-0.37\tau}{1-0.81\tau} \\
  \bottomrule
  \end{tabular}

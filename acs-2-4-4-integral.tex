...
\[
w=-\kkp x-\kki z+k_fv_r=-Kx+k_fv_r,  \qquad K = \Matr{\kkp & \kki}
\]
...
\[\operatorname{det}(sI-A+BK) = s^2+(b\kkp+a)s+b\kki.\]
Therefore, 
\[\kkp=\frac{a_1-a}{b}, \quad \kki=\frac{a_2}{b}, \quad k_f=\frac{a_1}{a}.\]
\end{frame}
...
\item In the previous example we see that if $b=0$, there are no values of $\kki$ that make the constant term of our characteristic polynomial equal to the constant term of the desired characteristic polynomial $a_2$
\end{itemize}
\end{frame}

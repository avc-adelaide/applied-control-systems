...
\begin{itemize}
	...
	\item For a gain curve of constant slope around $\omega_{gc}$, the slope $n_{gc}$ is related to the phase margin $\phasemargin$ (in degrees) by
	\[n_{gc} \approx -2 + \frac{\phasemargin}{90}\]

...
\begin{frame}
\frametitle{Balance system example}
\framesubtitle{Referencing Example 7.2}

\begin{center}
\begin{figure}
	\centering
	\includegraphics[width=0.75\linewidth]{figure7.11}
	\\
	\textbf{Figure 7.11:} State feedback control of a balance system (4 states, 2 pairs of complex eigenvalues).
\end{figure}
\end{center}

...
\item For $n$ poles and $m$ zeros, $\npoleexcess = n-m$ is the \alert{pole excess} or \alert{relative degree} of the TF
\item $\npoleexcess\ge 0$ is a \alert{proper} system; $\npoleexcess>0$ is \alert{strictly proper}
